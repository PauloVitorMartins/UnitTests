...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  ...
  it('teste se o objeto retornado possui 3 propiedades', () => {
 ...
 // Teste se a função, quando não recebe nenhum parâmetro, retorna undefined.
  ...
  it('teste se dentro do objeto retornado, a função retorna uma key com value igual a circunferência correta para um cpírculo de raio 2', () => {
